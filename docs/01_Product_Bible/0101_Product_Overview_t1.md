...
- [1. Продукт одним абзацем](#1-продукт-одним-абзацем)
- [2. Какую проблему решает продукт](#2-какую-проблему-решает-продукт)
- [3. Чем Family Economy не является](#3-чем-family-economy-не-является)
- [4. Главная продуктовая идея](#4-главная-продуктовая-идея)
- [5. Основные пользователи и роли](#5-основные-пользователи-и-роли)
- [6. Модель двух приложений](#6-модель-двух-приложений)
- [7. Основной цикл](#7-основной-цикл)
- [8. Продуктовые модули](#8-продуктовые-модули)
- [9. Карта зрелости модулей](#9-карта-зрелости-модулей)
- [10. Границы продукта](#10-границы-продукта)
- [11. Модель безопасности на продуктовом уровне](#11-модель-безопасности-на-продуктовом-уровне)
- [12. Модель наград](#12-модель-наград)
- [13. Модель экономики](#13-модель-экономики)
- [14. Модель контрактов](#14-модель-контрактов)
- [15. Модель персонажей](#15-модель-персонажей)
- [16. Модель семейного рынка](#16-модель-семейного-рынка)
- [17. Казначейство и Государство семьи](#17-казначейство-и-государство-семьи)
- [18. Фотоотчеты и ИИ-помощник](#18-фотоотчеты-и-ии-помощник)
- [19. Почему этот продукт можно продавать](#19-почему-этот-продукт-можно-продавать)
- [20. Итог](#20-итог)
...
## 3. Чем Family Economy не является
...
## 11. Модель безопасности на продуктовом уровне
...
## 17. Казначейство и Государство семьи
...
## 19. Почему этот продукт можно продавать
